...
namespace Method_Submission_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int results2 = math1.MultiplyNumbers(5.5m);
            int results3 = math1.DivideString("20");
            ...
            Console.WriteLine($"Using method to take string \"20\" convert to int and divide it by 3 which equals: {results3}");
